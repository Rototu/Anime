...
var ScrollModule = ( function () {
   ...
   return {
      ...
      init: function () {
         ...
         $( "#menu1" )
            .css( "color", "rgb(15,15,15)" );
         blueTweenWidth = $( "#menu1" )
            .width() + 2 * parseInt( $( "#menu1" )
               .css( "padding-left" ) );
         ...
         $( ".menuSelector" )
            .on( {
               ...
               mouseenter: function () {
                  ...
                  // set to init state
                  $( ".menuSelector" )
                     .css( "color", "rgb(149,149,149)" );

                  // get element props
                  blueTweenWidth = $( this )
                     .width() + 2 * parseInt( $( this )
                        .css( "padding-left" ) );
                  blueTweenOffset = $( this )
                     .offset()
                     .left;
         ...
         $( "#menuElements" )
            .on( {
               ...
               mouseleave: function () {
                  ...
                  // get el props
                  blueTweenWidth = $( "#menu" + i )
                     .width() + 2 * parseInt( $( "#menu" + i )
                        .css( "padding-left" ) )
                  blueTweenOffset = $( "#menu" + i )
                     .offset()
                     .left;
      ...
      animations: function () {
         ...
         var scrollAnimation = function () {
            ...
            if ( relativeTopPos <= windowHeight ) {
               ...
               $( "#menu" )
                  .css( "top", windowHeight + ( 1 - relativeTopPos / windowHeight ) * 50 );
               $( "#menu, #menuFill" )
                  .css( "opacity", relativeTopPos / windowHeight + 0.1 );
               $( "#menuFill" )
                  .css( "height", $( "#menu" )
                     .position()
                     .top - windowHeight );
            ...
            if ( relativeTopPos >= windowHeight && relativeTopPos < 2 * windowHeight ) {
               ...
               if ( !elFixed ) {
                  ...
                  // prezTxt class control
                  $prezTxt.addClass( "affix" )
                     .removeClass( "bottomSticky" );
