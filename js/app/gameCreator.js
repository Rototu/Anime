   ...
   return {
      ...
      bindHandlers: function () {
         ...
         $(".bitBox").click(function() {
            $(this).toggleClass("bitSelected");
            var bit = $(this).attr("name");
            if(myMap[bit] == 1) {
               myMap[bit] = 0;
            } else {
               myMap[bit] =1;
      ...
      uploadImg: function() {
         ...
         $("#selectedLevel").prop("src", "img/game/levels/" + $("#levelSelector").val());
         $(".bitBox").removeClass("bitSelected");
         myMap.fill(0);
